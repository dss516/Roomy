...
module.exports.showListing = async (req,res)=>{
    ...
    if(!listing){
        req.flash("error","The Listing You are trying to access doesnot exist!");
...
module.exports.renderEditForm = async (req,res)=>{
    ...
    const listing = await Listing.findById(id);
        if(!listing){
        req.flash("error","The Listing You are trying to edit doesnot exist!");
        res.redirect("/listings");
    }else{
...
module.exports.updateListing = async (req,res)=>{
    ...
    // let listingcord = await Listing.findByIdAndUpdate(id,{geometry:result.features[0].geometry});
